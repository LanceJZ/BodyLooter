...
namespace Engine
{
	public class PositionedObject : GameComponent, IBeginable
	{
        ...
        public Vector2 HeightWidth { get => m_HeightWidth; set => m_HeightWidth = value; }

        public Rectangle BoundingBox
        {
            get
            {
                return new Rectangle((int)Position.X, (int)Position.Y, (int)HeightWidth.X, (int)HeightWidth.Y);
            }
        }
        #endregion
        #region Constructor
